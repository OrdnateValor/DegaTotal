...
public class Item implements Serializable {
	...
	//////////
	private String itemId; // 아이템 ID ; 기본키
	private String itemNm; // 아이템 이름
	private String itemScr; // 아이템 스크린샷
	private String itemIco; // 아이템 아이콘
	private String itemDes; // 아이템 설명
	private String iRarity; // 아이템 희귀도(등급)
	private String iCategory; // 아이템 분류
	private String iSlot; // 아이템 유형(물리 ; 에너지 ; 중화기)
	//////////
	private String perkIco1; // 퍽 아이콘 1
	private String perkName1; // 퍽 이름 1
	private String perkDes1; // 퍽 설명 1
	private String perkIco2; // 퍽 아이콘 2
	private String perkName2; // 퍽 이름 2
	private String perkDes2; // 퍽 설명 2
	private String perkIco3; // 퍽 아이콘 3
	private String perkName3; // 퍽 이름 3
	private String perkDes3; // 퍽 설명 3
	private String perkIco4; // 퍽 아이콘 4
	private String perkName4; // 퍽 이름 4
	private String perkDes4; // 퍽 설명 4
	private String perkIco5; // 퍽 아이콘 5
	private String perkName5; // 퍽 이름 5
	private String perkDes5; // 퍽 설명 5
	////////////
	private int RPM; // 분당 발사수
	private int MAGAZINE; // 탄창
	//////////
	private String STAT1NM; // 스탯1 이름
	private int STAT1FIG; // 스탯1 수치
	private String STAT2NM; // 스탯2 이름
	private int STAT2FIG; // 스탯2 수치
	private String STAT3NM; // 스탯3 이름
	private int STAT3FIG; // 스탯3 수치
	private String STAT4NM; // 스탯4 이름
	private int STAT4FIG; // 스탯4 수치
	private String STAT5NM; // 스탯5 이름
	private int STAT5FIG; // 스탯5 수치
	/////////
