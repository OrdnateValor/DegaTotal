...
<div class="jumbotron">
	<div class="container">
		...
		<hr>
		<div class="container">
			<form action="/postUpdate.do?postId=${post.postId }" class="form-horizontal" method="post">
				...
				<div class="form-group row">
					<div class="col-xl-12" align="right">
						...
						<a href="/postList.do" type="button" class="btn btn-dark" >취소</a>
					</div>
				</div>
				<input type="hidden" name="_postThumb" value=${post.postThumb }>
			</form>
		</div>
	</div>
</div>
