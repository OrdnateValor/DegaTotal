...
CREATE TABLE dega_post_(
	...
	postThumb	VARCHAR2(100),					 -- 섬네일
	postSub		VARCHAR2(100) NOT NULL,			 -- 제목
	content		LONG VARCHAR,							 -- 내용
	regDate		DATE	DEFAULT SYSDATE
);
...
INSERT INTO item_info(itemid, itemnm, itemscr, itemico, itemdes) 
			VALUES ('I' || item_info_seq.NEXTVAL, '스페이드에이스', 'spadepce_scr.jpg', 'spadeace_ico.jpg', '"원래부터 접을 순 없었다구." -케이드-6');